...
* [WebSocket](https://docs.spring.io/spring-boot/docs/3.3.2-SNAPSHOT/reference/htmlsingle/index.html#messaging.websockets)
...
* [Spring Boot Actuator](https://docs.spring.io/spring-boot/docs/3.3.2-SNAPSHOT/reference/htmlsingle/index.html#actuator)
* [Flyway Migration](https://docs.spring.io/spring-boot/docs/3.3.2-SNAPSHOT/reference/htmlsingle/index.html#howto.data-initialization.migration-tool.flyway)
